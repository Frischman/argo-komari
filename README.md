...
# komari
RUN wget -O /tmp/komari.tar.gz \
https://github.com/komari-monitor/komari/releases/latest/download/komari_linux_amd64.tar.gz && \
tar -xzf /tmp/komari.tar.gz -C /usr/local/bin && \
